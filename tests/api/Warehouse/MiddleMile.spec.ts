...
test.describe(
  "Warehouse GraphQL API — Middle mile",
  { tag: ["@api", "@warehouse", "@middle-mile"] },
  () => {
    test.describe.configure({ timeout: 180_000 });

    test(
      "sending only — create, start send, confirm load, confirm sending",
      { tag: ["@middle-mile", "@sending", "@warehouse-regression"] },
      async ({ api }) => {
    ...
    test(
      ...
      { tag: ["@middle-mile", "@receiving", "@scales", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
    ...
    test(
      "sending then receiving with scales, sample code, and quality",
      {
        tag: [
          ...
          "@receiving",
          "@quality",
          "@create-middle-mile-with-quality",
    ...
    test(
      ...
      { tag: ["@middle-mile", "@sample", "@negative", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
    ...
    test(
      ...
      { tag: ["@middle-mile", "@quality", "@negative", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { tripLoadId } = await prepareInboundAfterFirstScale(wh);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@sample", "@quality", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
    ...
    test(
      ...
      { tag: ["@middle-mile", "@create", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const createPayload = buildCreateMiddleMileTripInput({
          items: [
    ...
    test(
      ...
      { tag: ["@middle-mile", "@scales", "@deductibles", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
    ...
    test(
      ...
      { tag: ["@middle-mile", "@sample", "@negative", "@order", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
        const tripLoadId = await startReceivingInbound(wh, middleMileTripId);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@scales", "@negative", "@order", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
        const tripLoadId = await startReceivingInbound(wh, middleMileTripId);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@quality", "@negative", "@order", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
        const tripLoadId = await startReceivingInbound(wh, middleMileTripId);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@receiving", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@receiving", "@confirm", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
        const tripLoadId = await startReceivingInbound(wh, middleMileTripId);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@delete", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { middleMileTripId } = await runSendingFlow(wh);
        const tripLoadId = await startReceivingInbound(wh, middleMileTripId);
    ...
    for (const productType of ["PRODUCT_2", "ACIDIC_OIL"] as const) {
      test(
        ...
        { tag: ["@middle-mile", "@quality", "@product-type", "@warehouse-regression"] },
        async ({ api }) => {
          const wh = api.warehouse;
          const { tripLoadId } = await prepareInboundAfterFirstScale(wh);
    ...
    test(
      ...
      { tag: ["@middle-mile", "@quality", "@optional-fields", "@warehouse-regression"] },
      async ({ api }) => {
        const wh = api.warehouse;
        const { tripLoadId } = await prepareInboundAfterFirstScale(wh);
