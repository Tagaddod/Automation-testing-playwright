...
test.describe("B2X trader form", () => {
  ...
  test(
    ...
    async () => {
      ...
      await expect(form.phoneErrorMessage).toBeHidden();
  ...
  test(
    ...
    async () => {
      ...
      await form.clickNext();
      await expect(form.nationalIdErrorMessage).toBeHidden();
  ...
  test(
    ...
    async () => {
      ...
      await form.clickNext();
      await expect(form.personalImageErrorMessage).toBeHidden();
      await expect(form.vehicleTypeErrorMessage).toBeVisible();
    },
  );
